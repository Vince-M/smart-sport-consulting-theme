    ...
    <div class="container row header__section">
      ...
      <nav class="nav flex flex-jc-sb flex-ai-c">
        <a href="index.html" class="header__logo">
          <img src="img/smart_sport_240x60.svg" width="240px" height="60px" alt="Smart Sport Consulting Inc.">
        </a>
        ...
        <ul class="nav__list mobile__fade">
          <li class="nav__item"><a href="#" class="nav__link">Certification</a></li>
          <li class="nav__item"><a href="#" class="nav__link">Consulting</a></li>
          <li class="nav__item"><a href="#" class="nav__link">Leadership</a></li>
          <li class="nav__item"><a href="#" class="nav__link">Blog/News</a></li>
